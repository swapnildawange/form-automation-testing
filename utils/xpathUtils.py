...
class Xpath_Util:
    ...
    def generate_xpath(self,soup):
                        ...
                        if element.has_attr(attr):
                            ...
                            if len(self.driver.find_elements(by=By.XPATH, value=locator))==1:
                                ...
                                if  variable_name != '' and variable_name not in self.variable_names:
                                    ...
                                    locatorValue = locator.encode('utf-8').decode('latin-1')
                                    self.variableToXpath[variable_name] = locatorValue
        ...
        return result_flag,self.variableToXpath
    ...
    def guess_xpath(self,tag,attr,element):
        ...
        tag: ['input','button']
        attr: ['id','name','placeholder','value','title','type','class']
        element: html element from soup
        """
